...
const TIPS = [
  ...
  "Nano can {highlight}configure itself{/highlight} if you ask it",
  "Ask Nano to {highlight}add Supabase MCP globally{/highlight}",
  "Ask Nano to {highlight}create a review agent for this project{/highlight}",
  "Ask Nano to {highlight}add a plugin for desktop alerts{/highlight}",
  "Ask Nano to {highlight}set Claude Sonnet as my default model{/highlight}",
  "Ask Nano to {highlight}make my review agent read-only{/highlight}",
  "Ask Nano to {highlight}require approval before git push{/highlight}",
  "Ask Nano to {highlight}turn off auto-formatting{/highlight}",
  "Ask Nano to {highlight}block access to .env files{/highlight}",
  "Ask Nano to {highlight}turn off the F2 shortcut{/highlight}",
  "Ask Nano to {highlight}match my terminal theme{/highlight}",
  "Ask Nano to {highlight}disable sharing for all sessions{/highlight}",
  "Ask Nano to {highlight}add rules from docs/ai-rules.md{/highlight}",
  "Ask Nano to {highlight}enable tui.scroll_acceleration{/highlight} for smooth macOS-style scrolling",
  "Ask Nano to {highlight}save this workflow as a /command{/highlight}",
  "Nano auto-handles OAuth for remote MCP servers requiring auth",
  "Nano auto-formats files using prettier, gofmt, ruff, and more",
  "Nano uses LSP servers for intelligent code analysis",
  "Use {highlight}nanocode run{/highlight} for non-interactive scripting",
  "Use {highlight}nanocode --continue{/highlight} to resume the last session",
  "Use {highlight}nanocode run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}nanocode serve{/highlight} for headless API access to Kilo",
