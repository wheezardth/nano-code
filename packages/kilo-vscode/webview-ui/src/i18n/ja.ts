export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Nanoが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Nanoで{{provider}}モデルを使用します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してNanoで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Nanoで{{provider}}モデルを使用してください。",
  ...
  "dialog.server.description": "このアプリが接続するNanoサーバーを切り替えます。",
  ...
  "toast.update.description": "Nanoの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをNanoチームに報告してください: ",
  ...
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: NanoはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "Nanoには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.general.row.language.description": "Nanoの表示言語を変更します",
  "settings.general.row.appearance.title": "外観",
  "settings.general.row.appearance.description": "デバイスでのNanoの表示をカスタマイズします",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Nanoのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Nano の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Nano は最新バージョンです。",
  ...
  "settings.indexing.kiloModel.title": "Nanoモデルプリセット",
  "settings.indexing.kiloModel.description": "サポートされているNanoホスト型埋め込みモデルを選択します。",
  "settings.indexing.kiloSignIn.title": "Nanoへのサインインが必要です",
  "settings.indexing.kiloSignIn.description": "ホスト型埋め込みを使用するにはNanoにサインインしてください。",
  ...
  "settings.providers.betaNotice":
    "現在、設定画面で設定できるのはNano Gatewayプロバイダーのみです。他のプロバイダーの設定については、ベータ期間中にまもなく対応予定です。それまでの間は、CLIまたは設定ファイルを使用してプロバイダーを設定できます。私たちはNanoをオープンに保ち、ロックインのない状態を維持することをお約束します。",
  ...
  "settings.models.hidePromptTraining.description":
    "プロバイダーがプロンプトを学習に使用する可能性のある Nano Gateway モデルを非表示にします。",
  ...
  "settings.config.title": "{{scope}}のNano構成ファイルを開く",
  ...
  "workStyle.onboarding.welcome": "Nanoへようこそ",
  ...
  "workStyle.choice.human-in-the-loop.description": "Nanoは作業中に一時停止し、計画を表示します。",
  ...
  "deviceAuth.title": "Nano Codeにサインイン",
  ...
  "profile.action.login": "Nano Codeでログイン",
  ...
  "settings.aboutKiloCode.title": "Nano Codeについて",

  "session.messages.empty": "下にメッセージを入力して会話を始めましょう。",
  "session.messages.welcome":
    "Nano CodeはAIコーディングアシスタントです。機能の構築、バグの修正、コードベースの説明を依頼できます。",
  ...
  "settings.aboutKiloCode.importSettings.invalidConfig": "ファイルに有効な Nano の設定が含まれていません。",
  "settings.aboutKiloCode.importSettings.tooLarge": "ファイルが大きすぎます。設定ファイルは 1 MB 以下にしてください。",
  "settings.aboutKiloCode.importSettings.newerVersion":
    "このファイルはより新しいバージョンの Nano からエクスポートされたものです。一部の設定が無視される場合があります。",
  ...
  "settings.language.description": "Nano Code UIの言語を選択します。「自動」はVS Codeの表示言語を使用します。",
  ...
  "settings.experimental.remote.description":
    "Nano Cloud 経由でのセッションの Remote コントロールを有効にします。これはこのマシンの CLI にも影響します。",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Claude Code の設定ディレクトリから CLAUDE.md のインストラクションとスキルをセッションに読み込みます。Nano に Claude Code のインストラクションとスキルを使用させる場合は、これを有効にしてください。再起動が必要です。",
  ...
  "settings.display.fontSize.description": "VS Code とは独立して Nano webview UI のフォントサイズを調整します。",
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "プロバイダーのAPIキーやデフォルトモデルなど、以前にインストールしたNano Codeから設定を移行します。",
  ...
  // Screen 1 — What's New
  "migration.whatsNew.title": "Nano Codeの新機能",
  ...
  "migration.whatsNew.features.foundation.detail":
    "すべてのNano製品で共有される小さく効率的なコア。どのような作業スタイルでも馴染みのある体験を提供します。",
  ...
  "diffViewer.source.session.tooltip":
    "現在のセッション中に Nano が変更したファイル。ターンごとのスナップショットに基づきます。新しいセッションを開始するとリセットされます。",
