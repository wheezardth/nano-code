export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Nano",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i Nano.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i Nano.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i Nano.",
  ...
  "dialog.server.description": "Skift hvilken Nano-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af Nano ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Nano-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Nano understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Nano inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Nano",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan Nano ser ud på din enhed",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan Nano er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Nano starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Nano.",
  ...
  "settings.indexing.kiloModel.title": "Nano-modelpreset",
  "settings.indexing.kiloModel.description": "Vælg en understøttet Nano-hostet embedding-model.",
  "settings.indexing.kiloSignIn.title": "Nano-login kræves",
  "settings.indexing.kiloSignIn.description": "Log ind på Nano for at bruge hostede embeddings.",
  ...
  "settings.providers.betaNotice":
    "I øjeblikket kan kun Nano Gateway-udbyderen konfigureres i indstillingsgrænsefladen. Understøttelse af konfiguration af andre udbydere kommer snart i løbet af betaperioden. I mellemtiden kan du konfigurere udbydere via CLI eller konfigurationsfilen. Vi er dedikerede til at holde Nano åben, ingen lock-in.",
  ...
  "settings.models.hidePromptTraining.description":
    "Skjul Nano Gateway-modeller, hvis udbydere muligvis bruger dine prompts til træning.",
  ...
  "settings.config.title": "Åbn {{scope}} Nano konfigurationsfil",
  ...
  "workStyle.choice.human-in-the-loop.description": "Nano holder pause og viser dig sin plan undervejs.",
  ...
  "deviceAuth.title": "Log ind på Nano Code",
  ...
  "profile.action.login": "Log ind med Nano Code",
  ...
  "session.messages.welcome":
    "Nano Code er en AI-kodningsassistent. Bed den om at bygge funktioner, rette fejl eller forklare din kodebase.",
  ...
  "settings.aboutKiloCode.extensionName": "Nano Code-udvidelse",
  ...
  "settings.aboutKiloCode.importSettings.invalidConfig": "Filen indeholder ikke gyldige Nano-indstillinger.",
  "settings.aboutKiloCode.importSettings.tooLarge": "Filen er for stor. Indstillingsfiler skal være under 1 MB.",
  "settings.aboutKiloCode.importSettings.newerVersion":
    "Denne fil blev eksporteret fra en nyere version af Nano. Nogle indstillinger kan blive ignoreret.",
  ...
  "settings.language.description": 'Vælg sproget til Nano Code-brugerfladen. "Auto" bruger VS Codes visningssprog.',
  ...
  "settings.experimental.remote.description":
    "Aktivér Remote-styring af sessioner via Nano Cloud. Dette vil også påvirke CLI'er på denne maskine.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Indlæs CLAUDE.md-instruktioner og -færdigheder fra din Claude Code-konfigurationsmappe i sessioner. Aktivér dette, hvis du vil have Nano til at bruge dine Claude Code-instruktioner og -færdigheder. Kræver genstart.",
  ...
  "settings.display.fontSize.description": "Juster skriftstørrelsen for Nano webview UI uafhængigt af VS Code.",
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "Migrer indstillinger fra en tidligere installation af Nano Code, herunder udbyder API-nøgler og standardmodel.",
  ...
  // Screen 1 — What's New
  "migration.whatsNew.title": "Nyheder i Nano Code",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Én lille, effektiv kerne på tværs af alle Nano-produkter. En velkendt oplevelse uanset hvordan du vælger at arbejde.",
  ...
  "diffViewer.source.session.tooltip":
    "Filer ændret af Nano i den aktuelle session, baseret på snapshots pr. tur. Nulstilles, når du starter en ny session.",
