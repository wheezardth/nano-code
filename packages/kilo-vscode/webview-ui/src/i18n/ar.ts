export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Nano",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Nano.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Nano.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Nano.",
  ...
  "dialog.server.description": "تبديل خادم Nano الذي يتصل به هذا التطبيق.",
  ...
  "toast.update.description": "نسخة جديدة من Nano ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Nano",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Nano لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن Nano نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Nano",
  "settings.general.row.appearance.title": "المظهر",
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Nano على جهازك",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Nano.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Nano",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Nano.",
  ...
  "settings.providers.betaNotice":
    "حالياً، يمكن إعداد مزود Nano Gateway فقط في واجهة الإعدادات. سيتوفر دعم إعداد المزودين الآخرين قريباً خلال الفترة التجريبية. في غضون ذلك، يمكنك إعداد المزودين باستخدام CLI أو ملف التكوين. نحن ملتزمون بإبقاء Nano مفتوحاً، دون تقييد.",
  ...
  "settings.models.hidePromptTraining.description":
    "إخفاء نماذج Nano Gateway التي قد يستخدم مزودوها مطالباتك لأغراض التدريب.",
  ...
  "settings.config.title": "فتح ملف تكوين Nano {{scope}}",
  ...
  "workStyle.onboarding.welcome": "مرحبًا بك في Nano",
  ...
  "workStyle.choice.human-in-the-loop.description": "يتوقف Nano مؤقتًا ويعرض لك خطته أثناء العمل.",
  ...
  "deviceAuth.title": "تسجيل الدخول إلى Nano Code",
  ...
  "profile.action.login": "تسجيل الدخول باستخدام Nano Code",
  ...
  "settings.indexing.kiloModel.title": "إعداد مسبق لنموذج Nano",
  "settings.indexing.kiloModel.description": "اختر نموذج تضمين مدعومًا ومستضافًا بواسطة Nano.",
  "settings.indexing.kiloSignIn.title": "تسجيل الدخول إلى Nano مطلوب",
  "settings.indexing.kiloSignIn.description": "سجّل الدخول إلى Nano لاستخدام التضمينات المستضافة.",
  ...
  "settings.aboutKiloCode.title": "حول Nano Code",

  "session.messages.empty": "ابدأ محادثة بكتابة رسالة أدناه.",
  "session.messages.welcome":
    "Nano Code هو مساعد ترميز بالذكاء الاصطناعي. اطلب منه بناء ميزات أو إصلاح أخطاء أو شرح قاعدة الشيفرة.",
  ...
  "settings.aboutKiloCode.extensionName": "إضافة Nano Code",
  ...
  "settings.aboutKiloCode.importSettings.invalidConfig": "الملف لا يحتوي على إعدادات Nano صالحة.",
  "settings.aboutKiloCode.importSettings.tooLarge": "الملف كبير جدًا. يجب أن تكون ملفات الإعدادات أقل من 1 MB.",
  "settings.aboutKiloCode.importSettings.newerVersion":
    "تم تصدير هذا الملف من إصدار أحدث من Nano. قد يتم تجاهل بعض الإعدادات.",
  ...
  "settings.language.description": 'اختر اللغة لواجهة Nano Code. "تلقائي" يستخدم لغة عرض VS Code.',
  ...
  "settings.experimental.remote.description":
    "قم بتمكين التحكم Remote في الجلسات عبر Nano Cloud. سيؤثر هذا أيضًا على واجهات سطر الأوامر (CLIs) على هذا الجهاز.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "تحميل تعليمات ومهارات CLAUDE.md من مجلد إعدادات Claude Code إلى الجلسات. قم بتمكين هذا الخيار إذا كنت ترغب في أن يستخدم Nano مهارات وتعليمات Claude Code الخاصة بك. يتطلب إعادة التشغيل.",
  ...
  "settings.display.fontSize.description": "اضبط حجم خط webview UI الخاص بـ Nano بشكل مستقل عن VS Code.",
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "ترحيل الإعدادات من تثبيت سابق لـ Nano Code، بما في ذلك مفاتيح API لمقدمي الخدمة والنموذج الافتراضي.",
  ...
  // Screen 1 — What's New
  "migration.whatsNew.title": "ما الجديد في Nano Code",
  ...
  "migration.whatsNew.features.foundation.detail":
    "نواة صغيرة وفعالة واحدة عبر كل منتجات Nano. تجربة مألوفة بغض النظر عن طريقة عملك.",
  ...
  "diffViewer.source.session.tooltip":
    "الملفات التي غيّرها Nano خلال الجلسة الحالية، بناءً على لقطات لكل دور. يُعاد ضبطها عند بدء جلسة جديدة.",
