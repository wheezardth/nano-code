export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Nano",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Nano.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Nano.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Nano.",
  ...
  "dialog.server.description": "Switch which Nano server this app connects to.",
  ...
  "toast.update.description": "A new version of Nano Code ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Nano team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Nano does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Nano includes free models so you can start immediately.",
  ...
  "settings.general.row.language.description": "Change the display language for Nano",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Nano looks on your device",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Nano is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Nano Code launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Nano Code.",
  ...
  "settings.providers.betaNotice":
    "Currently only the Nano Gateway provider can be configured in the settings interface. Support for configuring other providers is coming soon during the beta period. In the interim you can configure providers using the CLI or config file. We're committed to keeping Nano open, no lock-in.",
  ...
  "provider.custom.title": "➕ Add Provider",
  ...
  "provider.custom.field.contextLength.label": "Context Length (tokens)",
  "provider.custom.field.contextLength.placeholder": "e.g. 131072",
  "provider.custom.error.contextLength.required": "Context length is required",
  "provider.custom.error.contextLength.format": "Must be a whole number of at least 1024",
  ...
  "settings.config.title": "Open {{scope}} Nano config file",
  ...
  "workStyle.onboarding.welcome": "Welcome to Nano",
  ...
  "workStyle.choice.human-in-the-loop.description": "Nano pauses and shows you its plan as it works.",
  ...
  "deviceAuth.title": "Sign in to Nano Code",
  ...
  "profile.action.login": "Login with Nano Code",
  ...
  "settings.indexing.kiloModel.title": "Nano model preset",
  "settings.indexing.kiloModel.description": "Choose a supported Nano-hosted embedding model.",
  "settings.indexing.kiloSignIn.title": "Nano sign-in required",
  "settings.indexing.kiloSignIn.description": "Sign in to Nano to use hosted embeddings.",
  ...
  "settings.aboutKiloCode.title": "About Nano Code",

  "session.messages.empty": "Start a conversation by typing a message below.",
  "session.messages.welcome":
    "Nano Code is an AI coding assistant. Ask it to build features, fix bugs, or explain your codebase.",
  ...
  "settings.aboutKiloCode.extensionName": "Nano Code Extension",
  ...
  "settings.aboutKiloCode.importSettings.invalidConfig": "File does not contain valid Nano settings.",
  "settings.aboutKiloCode.importSettings.tooLarge": "File is too large. Settings files must be under 1 MB.",
  "settings.aboutKiloCode.importSettings.newerVersion":
    "This file was exported from a newer version of Nano. Some settings may be ignored.",
  ...
  "settings.language.description":
    'Choose the language for the Nano Code UI. "Auto" uses your VS Code display language.',
  ...
  "settings.experimental.remote.description":
    "Enable remote control of sessions via Nano Cloud. This will also affect CLIs on this machine.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Load CLAUDE.md instructions and skills from your Claude Code configuration directory into sessions. Enable this if you want Nano to use your Claude Code instructions and skills. Requires restart.",
  ...
  "settings.display.fontSize.description": "Adjust the Nano webview UI font size independently from VS Code.",
  ...
  "settings.models.hidePromptTraining.description":
    "Hide Nano Gateway models whose providers may use your prompts for training.",
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "Migrate settings from a previous installation of Nano Code, including provider API keys and default model.",
  ...
  // Screen 1 — What's New
  "migration.whatsNew.title": "What's New in Nano Code",
  ...
  "migration.whatsNew.features.foundation.detail":
    "One small, efficient core across every Nano product. A familiar experience however you choose to work.",
  ...
  "diffViewer.source.session.tooltip":
    "Files changed by Nano during the current session, based on per-turn snapshots. Resets when you start a new session.",
