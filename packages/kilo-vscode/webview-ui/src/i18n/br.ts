export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Nano",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Nano.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Nano.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Nano.",
  ...
  "dialog.server.description": "Trocar para qual servidor Nano este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do Nano ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Nano",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Nano ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Nano inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Nano",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o Nano aparece no seu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Nano é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Nano iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Nano.",
  ...
  "settings.providers.betaNotice":
    "Atualmente, apenas o provedor Nano Gateway pode ser configurado na interface de configurações. O suporte para a configuração de outros provedores estará disponível em breve durante o período beta. Enquanto isso, você pode configurar provedores usando a CLI ou o arquivo de configuração. Estamos comprometidos em manter o Nano aberto, sem lock-in.",
  ...
  "settings.models.hidePromptTraining.description":
    "Oculte os modelos do Nano Gateway cujos provedores podem usar seus prompts para treinamento.",
  ...
  "provider.custom.title": "➕ Adicionar provedor",
  ...
  "settings.config.title": "Abrir arquivo de configuração {{scope}} do Nano",
  ...
  "workStyle.onboarding.welcome": "Boas-vindas ao Nano",
  ...
  "workStyle.choice.human-in-the-loop.description": "O Nano pausa e mostra o plano enquanto trabalha.",
  ...
  "deviceAuth.title": "Entrar no Nano Code",
  ...
  "profile.action.login": "Entrar com Nano Code",
  ...
  "settings.indexing.kiloModel.title": "Predefinição de modelo do Nano",
  "settings.indexing.kiloModel.description": "Escolha um modelo de embedding hospedado pelo Nano compatível.",
  "settings.indexing.kiloSignIn.title": "Login no Nano necessário",
  "settings.indexing.kiloSignIn.description": "Entre no Nano para usar embeddings hospedados.",
  ...
  "settings.aboutKiloCode.title": "Sobre o Nano Code",

  "session.messages.empty": "Inicie uma conversa digitando uma mensagem abaixo.",
  "session.messages.welcome":
    "Nano Code é um assistente de programação com IA. Peça para criar funcionalidades, corrigir bugs ou explicar sua base de código.",
  ...
  "settings.aboutKiloCode.extensionName": "Extensão Nano Code",
  ...
  "settings.aboutKiloCode.importSettings.invalidConfig": "O arquivo não contém configurações válidas do Nano.",
  ...
  "settings.aboutKiloCode.importSettings.newerVersion":
    "Este arquivo foi exportado de uma versão mais recente do Nano. Algumas configurações podem ser ignoradas.",
  ...
  "settings.language.description":
    'Escolha o idioma da interface do Nano Code. "Auto" usa o idioma de exibição do VS Code.',
  ...
  "settings.experimental.remote.description":
    "Habilite o controle Remote de sessões via Nano Cloud. Isso também afetará as CLIs nesta máquina.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Carrega as instruções e skills do CLAUDE.md a partir do seu diretório de configuração do Claude Code para as sessões. Ative esta opção se deseja que o Nano utilize suas instruções e skills do Claude Code. Requer reinicialização.",
  ...
  "settings.display.fontSize.description":
    "Ajuste o tamanho da fonte da webview UI do Nano independentemente do VS Code.",
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "Migre as configurações de uma instalação anterior do Nano Code, incluindo chaves de API de provedor e modelo padrão.",
  ...
  // Screen 1 — What's New
  "migration.whatsNew.title": "O Que Há de Novo no Nano Code",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Um núcleo pequeno e eficiente em todos os produtos Nano. Uma experiência familiar independentemente de como você escolha trabalhar.",
  ...
  "diffViewer.source.session.tooltip":
    "Arquivos modificados pelo Nano durante a sessão atual, com base em snapshots por turno. Reinicia ao começar uma nova sessão.",
