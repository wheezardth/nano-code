export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Nano",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Nano.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Nano.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Nano.",
  ...
  "speechToText.tooltip.start": "Iniciar entrada de voz con Nano Gateway",
  ...
  "speechToText.error.loginRequired": "Inicia sesión en Nano para usar la entrada de voz.",
  ...
  "dialog.server.description": "Cambiar a qué servidor de Nano se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de Nano ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de Nano",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, Nano no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "Nano incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Nano",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve Nano en tu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Nano.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Nano",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Nano.",
  ...
  "settings.indexing.kiloModel.title": "Preajuste de modelo de Nano",
  "settings.indexing.kiloModel.description": "Elige un modelo de embeddings alojado por Nano compatible.",
  "settings.indexing.kiloSignIn.title": "Se requiere iniciar sesión en Nano",
  "settings.indexing.kiloSignIn.description": "Inicia sesión en Nano para usar embeddings alojados.",
  ...
  "settings.providers.betaNotice":
    "Actualmente, solo el proveedor Nano Gateway se puede configurar en la interfaz de ajustes. El soporte para configurar otros proveedores llegará pronto durante el período beta. Mientras tanto, puedes configurar proveedores usando la CLI o el archivo de configuración. Estamos comprometidos a mantener Nano abierto, sin ataduras.",
  ...
  "settings.models.hidePromptTraining.description":
    "Oculta los modelos de Nano Gateway cuyos proveedores pueden usar tus prompts para entrenamiento.",
  ...
  "settings.config.title": "Abrir archivo de configuración Nano {{scope}}",
  ...
  "workStyle.onboarding.welcome": "Te damos la bienvenida a Nano",
  ...
  "workStyle.choice.human-in-the-loop.description": "Nano se detiene y te muestra su plan mientras trabaja.",
  ...
  "deviceAuth.title": "Iniciar sesión en Nano Code",
  ...
  "profile.action.login": "Iniciar sesión con Nano Code",
  ...
  "settings.aboutKiloCode.title": "Acerca de Nano Code",

  "session.messages.empty": "Inicia una conversación escribiendo un mensaje a continuación.",
  "session.messages.welcome":
    "Nano Code es un asistente de programación con IA. Pídele que cree funcionalidades, corrija errores o explique tu código.",
  ...
  "settings.aboutKiloCode.importSettings.invalidConfig": "El archivo no contiene ajustes válidos de Nano.",
  ...
  "settings.aboutKiloCode.importSettings.newerVersion":
    "Este archivo fue exportado desde una versión más reciente de Nano. Algunos ajustes podrían ignorarse.",
  ...
  "settings.language.description":
    'Elige el idioma de la interfaz de Nano Code. "Auto" utiliza el idioma de visualización de VS Code.',
  ...
  "settings.experimental.speechToText.description":
    "Habilita la entrada de voz en los campos de prompt usando tu cuenta de Nano a través de Nano Gateway.",
  "settings.models.speechToText.disabledDescription":
    "Habilita e inicia sesión en el proveedor Nano para usar Speech to Text. Actualmente, Speech to Text solo es compatible con Nano Gateway.",
  "settings.models.speechToTextModel.title": "Modelo de voz a texto",
  "settings.models.speechToTextModel.description":
    "Elige el modelo de transcripción de Nano Gateway para la entrada de voz.",
  ...
  "settings.experimental.remote.description":
    "Habilite el control Remote de las sesiones a través de Nano Cloud. Esto también afectará a las CLI de este equipo.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Carga las instrucciones y habilidades de CLAUDE.md desde tu directorio de configuración de Claude Code en las sesiones. Activa esta opción si quieres que Nano utilice tus instrucciones y habilidades de Claude Code. Requiere reiniciar.",
  ...
  "settings.display.fontSize.description":
    "Ajusta el tamaño de fuente de la webview UI de Nano de forma independiente a VS Code.",
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "Migra la configuración de una instalación anterior de Nano Code, incluyendo las claves API de proveedores y el modelo predeterminado.",
  ...
  // Screen 1 — What's New
  "migration.whatsNew.title": "Novedades en Nano Code",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Un núcleo pequeño y eficiente en todos los productos Nano. Una experiencia familiar sin importar cómo elijas trabajar.",
  ...
  "diffViewer.source.session.tooltip":
    "Archivos modificados por Nano durante la sesión actual, basado en snapshots por turno. Se reinicia al empezar una nueva sesión.",
