...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Nano 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 Nano 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 Nano 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 並輸入以下程式碼，以連線你的帳戶並在 Nano 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切換此應用程式連線的 Nano 伺服器。",
  ...
  "toast.update.description": "Nano 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 Nano 團隊",
  ...
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意：Nano 暫不支援 MCP 認證。',
  ...
  "sidebar.gettingStarted.line1": "Nano 提供免費模型，你可以立即開始使用。",
  ...
  "settings.general.row.language.description": "變更 Nano 的顯示語言",
  "settings.general.row.appearance.title": "外觀",
  "settings.general.row.appearance.description": "自訂 Nano 在你的裝置上的外觀",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 Nano 的主題。",
  ...
  "settings.updates.row.startup.description": "在 Nano 啟動時自動檢查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 Nano。",
  ...
  "settings.providers.betaNotice":
    "目前在設定介面中僅能配置 Nano Gateway 供應商。在測試期間，即將推出配置其他供應商的支援。在此期間，您可以使用 CLI 或設定檔來配置供應商。我們致力於保持 Nano 開放，絕不綁定。",
  ...
  "settings.models.hidePromptTraining.description": "隱藏供應商可能會使用您的提示詞進行訓練的 Nano Gateway 模型。",
  ...
  "settings.config.title": "開啟 {{scope}} Nano 設定檔",
  ...
  "workStyle.onboarding.welcome": "歡迎使用 Nano",
  ...
  "workStyle.choice.human-in-the-loop.description": "Nano 會在工作過程中暫停並向你顯示其計畫。",
  ...
  "profile.action.login": "使用 Nano Code 登入",
  ...
  "settings.aboutKiloCode.title": "關於 Nano Code",

  "session.messages.empty": "在下方輸入訊息以開始對話。",
  "session.messages.welcome": "Nano Code 是一個 AI 程式設計助手。讓它幫你建構功能、修復 bug 或解釋程式碼庫。",
  ...
  "settings.aboutKiloCode.importSettings.invalidConfig": "檔案不包含有效的 Nano 設定。",
  "settings.aboutKiloCode.importSettings.tooLarge": "檔案過大。設定檔必須小於 1 MB。",
  "settings.aboutKiloCode.importSettings.newerVersion": "此檔案由較新版本的 Nano 匯出。部分設定可能會被忽略。",
  ...
  "settings.language.description": "選擇 Nano Code 介面的語言。「自動」使用 VS Code 的顯示語言。",
  ...
  "settings.experimental.remote.description": "透過 Nano Cloud 啟用工作階段的 Remote 控制。這也會影響此電腦上的 CLI。",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "從您的 Claude Code 設定目錄將 CLAUDE.md 指示與技能載入至工作階段中。如果您希望 Nano 使用您的 Claude Code 指示與技能，請啟用此選項。需要重新啟動。",
  ...
  "settings.display.fontSize.description": "獨立於 VS Code 調整 Nano webview UI 的字體大小。",
  ...
  "settings.indexing.kiloModel.title": "Nano 模型預設",
  "settings.indexing.kiloModel.description": "選擇支援的 Nano 託管嵌入模型。",
  "settings.indexing.kiloSignIn.title": "需要登入 Nano",
  "settings.indexing.kiloSignIn.description": "登入 Nano 以使用託管嵌入。",
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "從舊版 Nano Code 安裝遷移設定，包括供應商 API 金鑰和預設模型。",
  ...
  // Screen 1 — What's New
  "migration.whatsNew.title": "Nano Code 新功能",
  ...
  "migration.whatsNew.features.foundation.detail":
    "所有 Nano 產品共享一個小巧高效的核心。無論你選擇哪種方式工作，都能獲得熟悉的體驗。",
  ...
  "diffViewer.source.session.tooltip": "Nano 在目前工作階段中變更的檔案，依據每輪快照。開始新工作階段時重置。",
