...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Nano",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Nano zu nutzen.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in Nano zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Nano zu nutzen.",
  ...
  "dialog.server.description": "Wechseln Sie den Nano-Server, mit dem sich diese App verbindet.",
  ...
  "toast.update.description": "Eine neue Version von Nano ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Nano-Team",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Nano unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "Nano enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Nano ändern",
  "settings.general.row.appearance.title": "Erscheinungsbild",
  "settings.general.row.appearance.description": "Anpassen, wie Nano auf Ihrem Gerät aussieht",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Nano anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Nano automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von Nano.",
  ...
  "settings.indexing.kiloModel.title": "Nano-Modellvoreinstellung",
  "settings.indexing.kiloModel.description": "Wählen Sie ein unterstütztes von Nano gehostetes Embedding-Modell.",
  "settings.indexing.kiloSignIn.title": "Nano-Anmeldung erforderlich",
  "settings.indexing.kiloSignIn.description": "Melden Sie sich bei Nano an, um gehostete Embeddings zu verwenden.",
  ...
  "settings.models.hidePromptTraining.description":
    "Blendet Nano-Gateway-Modelle aus, deren Anbieter Ihre Prompts möglicherweise zum Training verwenden.",
  ...
  "settings.config.title": "{{scope}} Nano-Konfigurationsdatei öffnen",
  ...
  "workStyle.onboarding.welcome": "Willkommen bei Nano",
  ...
  "workStyle.choice.human-in-the-loop.description": "Nano pausiert und zeigt dir während der Arbeit seinen Plan.",
  ...
  "deviceAuth.title": "Bei Nano Code anmelden",
  ...
  "profile.action.login": "Mit Nano Code anmelden",
  ...
  "settings.aboutKiloCode.title": "Über Nano Code",

  "session.messages.empty": "Starten Sie eine Unterhaltung, indem Sie unten eine Nachricht eingeben.",
  "session.messages.welcome":
    "Nano Code ist ein KI-Programmierassistent. Bitten Sie ihn, Funktionen zu erstellen, Fehler zu beheben oder Ihre Codebasis zu erklären.",
  ...
  "settings.aboutKiloCode.extensionName": "Nano Code Erweiterung",
  ...
  "settings.aboutKiloCode.importSettings.invalidConfig": "Die Datei enthält keine gültigen Nano-Einstellungen.",
  ...
  "settings.aboutKiloCode.importSettings.newerVersion":
    "Diese Datei wurde mit einer neueren Version von Nano exportiert. Einige Einstellungen werden möglicherweise ignoriert.",
  ...
  "settings.language.description":
    'Wählen Sie die Sprache für die Nano Code Oberfläche. „Auto" verwendet die VS Code Anzeigesprache.',
  ...
  "settings.experimental.remote.description":
    "Aktivieren Sie die Remote-Steuerung von Sitzungen über Nano Cloud. Dies betrifft auch CLIs auf diesem Computer.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Lädt CLAUDE.md-Anweisungen und Skills aus Ihrem Claude Code-Konfigurationsverzeichnis in Sitzungen. Aktivieren Sie dies, wenn Nano Ihre Claude Code-Anweisungen und Skills verwenden soll. Neustart erforderlich.",
  ...
  "settings.display.fontSize.description": "Passen Sie die Schriftgröße der Nano webview UI unabhängig von VS Code an.",
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "Migrieren Sie Einstellungen von einer früheren Installation von Nano Code, einschließlich Anbieter-API-Schlüsseln und dem Standardmodell.",
  ...
  // Screen 1 — What's New
  "migration.whatsNew.title": "Neuigkeiten in Nano Code",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Ein kleiner, effizienter Kern über alle Nano-Produkte hinweg. Ein vertrautes Erlebnis, egal wie Sie arbeiten.",
  ...
  "diffViewer.source.session.tooltip":
    "Von Nano während der aktuellen Sitzung geänderte Dateien, basierend auf Snapshots pro Runde. Wird beim Start einer neuen Sitzung zurückgesetzt.",
