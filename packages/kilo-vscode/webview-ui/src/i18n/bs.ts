export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Nano",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Nano-u.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Nano-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Nano-u.",
  ...
  "dialog.server.description": "Promijeni na koji se Nano server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija Nano-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Nano timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Nano još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Nano uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Nano-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako Nano izgleda na tvom uređaju",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Nano-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Nano pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Nano-a.",
  ...
  "settings.indexing.kiloModel.title": "Preset Nano modela",
  "settings.indexing.kiloModel.description": "Odaberite podržani model embeddinga hostovan na Nano.",
  "settings.indexing.kiloSignIn.title": "Potrebna je prijava na Nano",
  "settings.indexing.kiloSignIn.description": "Prijavite se na Nano za korištenje hostovanih embeddinga.",
  ...
  "settings.providers.betaNotice":
    "Trenutno se samo Nano Gateway provajder može konfigurisati u interfejsu za postavke. Podrška za konfigurisanje drugih provajdera stiže uskoro tokom beta perioda. U međuvremenu, provajdere možete konfigurisati koristeći CLI ili konfiguracijsku datoteku. Posvećeni smo tome da Nano ostane otvoren, bez vezivanja.",
  ...
  "settings.models.hidePromptTraining.description":
    "Sakrij Nano Gateway modele čiji pružaoci mogu koristiti vaše promptove za treniranje.",
  ...
  "settings.config.title": "Otvori {{scope}} Nano konfiguracijsku datoteku",
  ...
  "workStyle.onboarding.welcome": "Dobro došli u Nano",
  ...
  "workStyle.choice.human-in-the-loop.description": "Nano zastaje i prikazuje vam svoj plan tokom rada.",
  ...
  "deviceAuth.title": "Prijavite se u Nano Code",
  ...
  "profile.action.login": "Prijavite se putem Nano Code",
  ...
  "settings.aboutKiloCode.title": "O Nano Code-u",

  "session.messages.empty": "Započnite razgovor unosom poruke ispod.",
  "session.messages.welcome":
    "Nano Code je AI asistent za programiranje. Zatražite da gradi funkcionalnosti, ispravlja greške ili objasni vašu bazu koda.",
  ...
  "settings.aboutKiloCode.extensionName": "Nano Code ekstenzija",
  ...
  "settings.aboutKiloCode.importSettings.invalidConfig": "Fajl ne sadrži važeće Nano postavke.",
  "settings.aboutKiloCode.importSettings.tooLarge": "Fajl je prevelik. Fajlovi s postavkama moraju biti manji od 1 MB.",
  "settings.aboutKiloCode.importSettings.newerVersion":
    "Ovaj fajl je izvezen iz novije verzije Nano-a. Neke postavke mogu biti zanemarene.",
  ...
  "settings.language.description": 'Odaberite jezik za Nano Code sučelje. "Auto" koristi jezik prikaza VS Code-a.',
  ...
  "settings.experimental.remote.description":
    "Omogućite Remote kontrolu sesija putem Nano Cloud. Ovo će također utjecati na CLI-jeve na ovoj mašini.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Učitajte CLAUDE.md instrukcije i vještine iz vašeg Claude Code konfiguracijskog direktorija u sesije. Omogućite ovo ako želite da Nano koristi vaše Claude Code instrukcije i vještine. Zahtijeva ponovno pokretanje.",
  ...
  "settings.display.fontSize.description": "Prilagodite veličinu fonta za Nano webview UI nezavisno od VS Code-a.",
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "Migrirajte postavke iz prethodne instalacije Nano Code, uključujući API ključeve provajdera i podrazumijevani model.",
  ...
  // Screen 1 — What's New
  "migration.whatsNew.title": "Šta je novo u Nano Code",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Jedno malo, efikasno jezgro kroz sve Nano proizvode. Poznato iskustvo bez obzira na to kako odaberete raditi.",
  ...
  "diffViewer.source.session.tooltip":
    "Datoteke koje je Nano promijenio tokom trenutne sesije, na osnovu snapshota po koraku. Resetuje se kada pokrenete novu sesiju.",
