export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen aangeboden door Nano",
  ...
  "provider.connect.apiKey.description":
    "Voer uw {{provider}} API-sleutel in om uw account te verbinden en {{provider}} modellen te gebruiken in Nano.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " om uw autorisatiecode op te halen waarmee u uw account kunt verbinden en {{provider}} modellen kunt gebruiken in Nano.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om uw account te verbinden en {{provider}} modellen te gebruiken in Nano.",
  ...
  "dialog.server.description": "Wissel met welke Nano-server deze app verbinding maakt.",
  ...
  "toast.update.description": "Een nieuwe versie van Nano ({{version}}) is nu beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Meld deze fout alsjeblieft aan het Nano team",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op, Nano ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "Nano bevat gratis modellen, zodat je meteen kunt beginnen.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor Nano",
  "settings.general.row.appearance.title": "Uiterlijk",
  "settings.general.row.appearance.description": "Pas aan hoe Nano eruitziet op je apparaat",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van Nano aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer Nano start",
  ...
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van Nano.",
  ...
  "settings.providers.betaNotice":
    "Momenteel kan alleen de Nano Gateway-provider worden geconfigureerd in de instellingeninterface. Ondersteuning voor het configureren van andere providers komt binnenkort tijdens de bèta-periode. In de tussentijd kun je providers configureren met behulp van de CLI of het configuratiebestand. We zijn toegewijd om Nano open te houden, geen lock-in.",
  ...
  "settings.config.title": "Open {{scope}} Nano-configuratiebestand",
  ...
  "workStyle.onboarding.welcome": "Welkom bij Nano",
  ...
  "workStyle.choice.human-in-the-loop.description": "Nano pauzeert en toont tijdens het werk zijn plan.",
  ...
  "deviceAuth.title": "Meld je aan bij Nano Code",
  ...
  "profile.action.login": "Inloggen met Nano Code",
  ...
  "settings.aboutKiloCode.title": "Over Nano Code",

  "session.messages.empty": "Start een gesprek door hieronder een bericht te typen.",
  "session.messages.welcome":
    "Nano Code is een AI-codeerassistent. Vraag het om features te bouwen, bugs op te lossen of je codebase uit te leggen.",
  ...
  "settings.aboutKiloCode.importSettings.invalidConfig": "Het bestand bevat geen geldige Nano-instellingen.",
  ...
  "settings.aboutKiloCode.importSettings.newerVersion":
    "Dit bestand is geëxporteerd vanuit een nieuwere versie van Nano. Sommige instellingen worden mogelijk genegeerd.",
  ...
  "settings.language.description": 'Kies de taal voor de Nano Code UI. "Auto" gebruikt je VS Code schermtaal.',
  ...
  "settings.experimental.remote.description":
    "Schakel Remote-bediening van sessies in via Nano Cloud. Dit heeft ook invloed op CLI's op deze machine.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Laad CLAUDE.md instructies en vaardigheden uit je Claude Code configuratiemap in sessies. Schakel dit in als je wilt dat Nano je Claude Code instructies en vaardigheden gebruikt. Herstart vereist.",
  ...
  "settings.display.fontSize.description": "Pas de lettergrootte van de Nano webview UI onafhankelijk van VS Code aan.",
  ...
  "settings.models.hidePromptTraining.description":
    "Verberg Nano Gateway-modellen waarvan providers je prompts mogelijk voor training gebruiken.",
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "Migreer instellingen van een eerdere installatie van Nano Code, inclusief provider API-sleutels en standaard model.",
  ...
  // Screen 1 — What's New
  "migration.whatsNew.title": "Wat is er Nieuw in Nano Code",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Één kleine, efficiënte kern voor elk Nano-product. Een vertrouwde ervaring, hoe je ook wilt werken.",
  ...
  "settings.indexing.kiloModel.title": "Nano-model voorinstelling",
  "settings.indexing.kiloModel.description": "Kies een ondersteund Nano-hosted embeddings model.",
  "settings.indexing.kiloSignIn.title": "Nano-aanmelding vereist",
  "settings.indexing.kiloSignIn.description": "Log in op Nano om hosted embeddings te gebruiken.",
  ...
  "diffViewer.source.session.tooltip":
    "Bestanden die door Nano tijdens de huidige sessie zijn gewijzigd, gebaseerd op snapshots per beurt. Wordt gereset bij het starten van een nieuwe sessie.",
