export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Nano",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Nano.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Nano.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Nano.",
  ...
  "speechToText.tooltip.start": "Rozpocznij wprowadzanie głosowe z Nano Gateway",
  ...
  "speechToText.error.loginRequired": "Zaloguj się do Nano, aby korzystać z wprowadzania głosowego.",
  ...
  "dialog.server.description": "Przełącz serwer Nano, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja Nano ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Nano",
  ...
  "error.chain.mcpFailed":
    'Serwer MCP "{{name}}" nie powiódł się. Uwaga, Nano nie obsługuje jeszcze uwierzytelniania MCP.',
  ...
  "sidebar.gettingStarted.line1": "Nano zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Nano",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd Nano na swoim urządzeniu",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Nano.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Nano",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Nano.",
  ...
  "settings.providers.betaNotice":
    "Obecnie w interfejsie ustawień można skonfigurować tylko dostawcę Nano Gateway. Obsługa konfiguracji innych dostawców pojawi się wkrótce w fazie beta. W międzyczasie możesz konfigurować dostawców za pomocą CLI lub pliku konfiguracyjnego. Zależy nam na zachowaniu otwartości Nano, bez lock-inu.",
  ...
  "settings.models.hidePromptTraining.description":
    "Ukryj modele Nano Gateway, których dostawcy mogą używać Twoich promptów do trenowania.",
  ...
  "settings.config.title": "Otwórz plik konfiguracyjny Nano ({{scope}})",
  ...
  "workStyle.onboarding.welcome": "Witamy w Nano",
  ...
  "workStyle.choice.human-in-the-loop.description": "Nano wstrzymuje pracę i pokazuje swój plan w trakcie działania.",
  ...
  "deviceAuth.title": "Zaloguj się do Nano Code",
  ...
  "profile.action.login": "Zaloguj się przez Nano Code",
  ...
  "settings.aboutKiloCode.title": "O Nano Code",

  "session.messages.empty": "Rozpocznij rozmowę, wpisując wiadomość poniżej.",
  "session.messages.welcome":
    "Nano Code to asystent programowania AI. Poproś go o tworzenie funkcji, naprawę błędów lub wyjaśnienie bazy kodu.",
  ...
  "settings.aboutKiloCode.importSettings.invalidConfig": "Plik nie zawiera prawidłowych ustawień Nano.",
  "settings.aboutKiloCode.importSettings.tooLarge": "Plik jest za duży. Pliki ustawień muszą mieć mniej niż 1 MB.",
  "settings.aboutKiloCode.importSettings.newerVersion":
    "Ten plik został wyeksportowany z nowszej wersji Nano. Niektóre ustawienia mogą zostać zignorowane.",
  ...
  "settings.language.description": 'Wybierz język interfejsu Nano Code. „Auto" używa języka wyświetlania VS Code.',
  ...
  "settings.experimental.speechToText.description":
    "Włącz wprowadzanie głosowe w polach promptów przy użyciu konta Nano za pośrednictwem Nano Gateway.",
  "settings.models.speechToText.disabledDescription":
    "Włącz i zaloguj się do dostawcy Nano, aby korzystać ze Speech to Text. Speech to Text jest obecnie obsługiwane tylko z Nano Gateway.",
  "settings.models.speechToTextModel.title": "Model mowy na tekst",
  "settings.models.speechToTextModel.description":
    "Wybierz model transkrypcji Nano Gateway dla wprowadzania głosowego.",
  ...
  "settings.experimental.remote.description":
    "Włącz sterowanie Remote sesjami za pośrednictwem Nano Cloud. Wpłynie to również na CLI na tej maszynie.",
  ...
  "settings.indexing.kiloModel.title": "Preset modelu Nano",
  "settings.indexing.kiloModel.description": "Wybierz obsługiwany model osadzania hostowany przez Nano.",
  "settings.indexing.kiloSignIn.title": "Wymagane logowanie do Nano",
  "settings.indexing.kiloSignIn.description": "Zaloguj się do Nano, aby używać hostowanych osadzeń.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Wczytuje instrukcje CLAUDE.md oraz umiejętności z katalogu konfiguracyjnego Claude Code do sesji. Włącz tę opcję, jeśli chcesz, aby Nano korzystał z Twoich instrukcji i umiejętności Claude Code. Wymaga ponownego uruchomienia.",
  ...
  "settings.display.fontSize.description": "Dostosuj rozmiar czcionki webview UI Nano niezależnie od VS Code.",
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "Migruj ustawienia z poprzedniej instalacji Nano Code, w tym klucze API dostawców i domyślny model.",
  ...
  // Screen 1 — What's New
  "migration.whatsNew.title": "Co nowego w Nano Code",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Jedno małe, wydajne jądro we wszystkich produktach Nano. Znajome doświadczenie niezależnie od sposobu pracy.",
  ...
  "diffViewer.source.session.tooltip":
    "Pliki zmienione przez Nano w trakcie bieżącej sesji, na podstawie snapshotów na turę. Resetowane przy rozpoczęciu nowej sesji.",
