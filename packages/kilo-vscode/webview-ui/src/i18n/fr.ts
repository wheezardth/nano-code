export const dict = {
  ...
  "provider.custom.title": "➕ Ajouter un fournisseur",
  ...
  "settings.config.source.homeNano": "Configuration .nano de Home",
  ...
  "settings.config.source.projectNano": "Configuration .nano du projet",
