...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Nano 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 Nano 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 Nano 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 Nano 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切换此应用连接的 Nano 服务器。",
  ...
  "toast.update.description": "Nano 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 Nano 团队",
  ...
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: Nano 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "Nano 提供免费模型，你可以立即开始使用。",
  ...
  "settings.general.row.language.description": "更改 Nano 的显示语言",
  "settings.general.row.appearance.title": "外观",
  "settings.general.row.appearance.description": "自定义 Nano 在你的设备上的外观",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 Nano 的主题。",
  ...
  "settings.updates.row.startup.description": "在 Nano 启动时自动检查更新",
  ...
  "settings.indexing.kiloModel.title": "Nano 模型预设",
  "settings.indexing.kiloModel.description": "选择受支持的 Nano 托管嵌入模型。",
  "settings.indexing.kiloSignIn.title": "需要登录 Nano",
  "settings.indexing.kiloSignIn.description": "登录 Nano 以使用托管嵌入。",
  ...
  "settings.providers.betaNotice":
    "目前只能在设置界面中配置 Nano Gateway 提供商。在 Beta 测试期间即将支持配置其他提供商。在此期间，您可以使用 CLI 或配置文件来配置提供商。我们致力于保持 Nano 开放，无锁定。",
  ...
  "settings.models.hidePromptTraining.description": "隐藏提供商可能会使用您的提示词进行训练的 Nano Gateway 模型。",
  ...
  "settings.config.title": "打开 {{scope}} Nano 配置文件",
  ...
  "workStyle.onboarding.welcome": "欢迎使用 Nano",
  ...
  "workStyle.choice.human-in-the-loop.description": "Nano 会在工作过程中暂停并向你展示其计划。",
  ...
  "profile.action.login": "使用 Nano Code 登录",
  ...
  "settings.aboutKiloCode.title": "关于 Nano Code",

  "session.messages.empty": "在下方输入消息以开始对话。",
  "session.messages.welcome": "Nano Code 是一个 AI 编程助手。让它帮你构建功能、修复 bug 或解释代码库。",
  ...
  "settings.aboutKiloCode.importSettings.invalidConfig": "文件不包含有效的 Nano 设置。",
  "settings.aboutKiloCode.importSettings.tooLarge": "文件过大。设置文件必须小于 1 MB。",
  "settings.aboutKiloCode.importSettings.newerVersion": "此文件由较新版本的 Nano 导出。部分设置可能会被忽略。",
  ...
  "settings.language.description": '"自动"将使用 VS Code 的显示语言。选择 Nano Code 界面的语言。',
  ...
  "settings.experimental.remote.description": "通过 Nano Cloud 启用会话的 Remote 控制。这也会影响此计算机上的 CLI。",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "将 Claude Code 配置目录中的 CLAUDE.md 指令和技能加载到会话中。如果您希望 Nano 使用您的 Claude Code 指令和技能，请启用此选项。需要重启。",
  ...
  "settings.display.fontSize.description": "独立于 VS Code 调整 Nano webview UI 的字体大小。",
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "从旧版 Nano Code 安装迁移设置，包括提供商 API 密钥和默认模型。",
  ...
  "migration.whatsNew.features.foundation.detail":
    "所有 Nano 产品共享一个小巧高效的核心。无论你选择哪种方式工作，都能获得熟悉的体验。",
  ...
  "diffViewer.source.session.tooltip": "Nano 在当前会话中更改的文件，基于每轮快照。开始新会话时重置。",
