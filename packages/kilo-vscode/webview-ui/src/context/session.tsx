...
export const SessionProvider: ParentComponent = (props) => {
  ...
  function handleSessionCreated(session: SessionInfo, draftID?: string) {
    ...
    batch(() => {
      ...
      // Only initialize messages if none exist yet — the SSE session.created
      // event can race with an already-populated message list, and wiping to
      // [] causes a flash of the empty/welcome screen.
