/**
 * Project directory resolution for standalone panels (Settings, Profile).
 *
 * ## Why this exists
 *
 ...
 * `workspaceFolders[0]` because the user may intend to install an item into
 * `/repo-b`, not `/repo-a`.
 *
 ...
 *    **disable project-scope operations** (e.g. installs default to global
 *    scope). This prevents silently writing config into the wrong project.
 *
