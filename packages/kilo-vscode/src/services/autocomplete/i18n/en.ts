...
export const dict = {
  ...
  "kilocode:autocomplete.progress.title": "Nano Code",
  ...
  "kilocode:autocomplete.input.title": "Nano Code: Quick Task",
  "kilocode:autocomplete.input.placeholder": "e.g., 'refactor this function to be more efficient'",
  "kilocode:autocomplete.commands.generateSuggestions": "Nano Code: Generate Suggested Edits",
  ...
  "kilocode:autocomplete.commands.category": "Nano Code",
  "kilocode:autocomplete.codeAction.title": "Nano Code: Suggested Edits",
  "kilocode:autocomplete.chatParticipant.fullName": "Nano Code Agent",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "The Nano Code Autocomplete is being blocked by a conflict with GitHub Copilot. To fix this, you must disable Copilot's inline suggestions.",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "Nano Code Autocomplete has been paused because your account has no remaining credits. Add credits to resume autocomplete.",
  "kilocode:autocomplete.creditsExhausted.addCredits": "Add Credits",
  "kilocode:autocomplete.authError.message":
    "Nano Code Autocomplete has been paused due to an authentication error. Please sign in again.",
}
